package com.lanou.lovemovie.welcome.selectlocation.citylist;
...
import com.lanou.lovemovie.welcome.selectlocation.adapter.HotCityGridAdapter;
import com.lanou.lovemovie.welcome.selectlocation.helper.ContactsHelper;
import com.lanou.lovemovie.welcome.selectlocation.storage.DBManager;
...
public class CityList extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        localGridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String cityModel = parent.getAdapter().getItem(position).toString();
        ...
        //如果选择了百度定位给我们自动生成的城市那么就存入shareperference中
    ...
    private void initOverlay() {
        ...
        //让window不能获得焦点，这样用户快就不能向该window发送按键事件及按钮事件 FLAG_NOT_FOCUSABLE
        // TYPE_APPLICATION普通的应用程序window，token必须设置为Activity的token，以指出该窗口属谁
        //  PixelFormat.TRANSLUCENT 使窗口支持透明度
