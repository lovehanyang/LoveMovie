 ...
 */
package com.lanou.lovemovie.dock.chat.HXChat.video.util;
...
//            yuv_Rotate90lr = new byte[mwidth * mheight * bitsperpixel / 8];
    ...
    boolean isScreenOriatationPortrait() {
        return AppApplication.getContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
