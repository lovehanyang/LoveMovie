 ...
 */
package com.lanou.lovemovie.dock.listen.musicplayer.adapter;
...
import com.lanou.lovemovie.dock.listen.musicplayer.IQueryFinished;
...
import com.lanou.lovemovie.dock.listen.musicplayer.utils.StringHelper;
...
public class MyAdapter extends BaseAdapter implements IConstants {
	...
	public void refreshPlayingList() {
		if(mMusicList.size() > 0) {
			...
			Log.i("lovehanyang","测试进入");
		}

		Log.i("lovehanyang","这里是MyAdapter"+mMusicList.toString());
